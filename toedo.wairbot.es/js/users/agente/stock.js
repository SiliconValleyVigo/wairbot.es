...
async function openStockAgente(id) {
    ...
    let eliminar = getBoton(texto = "Solicitar Maquina", funcion = "solicitarMaquinaAgente", id = idOriginal);
...
async function solicitarMaquinaAgente(id) {
    ...
    //modal de avisar que se ha solicitado el maquina createModalAviso(titulo, mensaje, funcionAceptar = null, arrayParametros = null)
