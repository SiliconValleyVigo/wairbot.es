...
function getDataList(id, label, options, value, oninputFunction){
    ...
    <div class="modalInputGroup">
        <div class="modalLabel">${label}</div>
        <input list="${id}_list" id="${id}" value="${valueName}" oninput="${oninputFunction}">
...
function getSimpleDataList(id, label, options, value) {
    console.log({id, label, options, value});
