...
//obtener el id de un modal
function getIdModalPadre(){
    //obtener el primer elemento con la clase modalTitulo
    let modalTitulo = document.getElementsByClassName('modalTitulo')[0];
    return modalTitulo.id;
}
