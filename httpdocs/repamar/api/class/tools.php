...
class Tools{
    ...
    static public function read($conn, $nPagina, $tabla, $filtro, $datosRelacionados, $search = null) {
        $sql = "SELECT $tabla.*";
    ...
    static public function getById($conn, $tabla, $id, $filtro, $datosRelacionados){
        ...
        // Ejecutar la consulta SQL
        $result = $conn->query($sql); //SELECT * FROM motores WHERE id = 107 AND id_agente = '2'

        //$datosRelacionados = ['nombreColumna' => 'tablaExtra'] // [id_motor => 'motores']
