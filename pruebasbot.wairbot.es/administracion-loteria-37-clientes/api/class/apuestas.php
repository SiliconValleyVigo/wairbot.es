    ...
    public static function crear($request){
        ...
        if($created){
            if($created['status'] == 'success'){
                ...
                $plazos = $data['plazos'];
                $message = "Hemos registrado un nuevo juego: $juego por la cantidad de $importe € para $plazos";
                $message .= " ¡Buena suerte! Accede a tu informacion en el enlace y pulsa Enviar: https://wa.me/34886080849?text=loterias37vigo";
                $file = $data['imagen'];
