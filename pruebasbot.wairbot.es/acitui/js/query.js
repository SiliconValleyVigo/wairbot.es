...
async function queryAsync(clase, funcion, datos) {
    ...
    console.log(datos);
    //si existe el elemento file_upload_documento
    //comprobar si datos.data.file_upload_documento existe en datos

    
    if (datos && datos.data && datos.data.file_upload_documento) {
        console.log(typeof datos.data.file_upload_documento, datos.data.file_upload_documento);
        console.log(JSON.stringify(datos));
    } else if (datos && datos.data) {
        console.log(datos.data);
        console.log(datos.data.fecha_ultima_factura);
        console.log(datos.data.file_upload_documento);
        console.log('no existe file_upload_documento');
    } else {
        console.log('datos.data es undefined');
    }
