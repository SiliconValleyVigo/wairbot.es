...
const camposProveedoresAdministrador = [
  {
    "tipo": "text",
    "id": "nombre",
    "label": "Nombre",
...
const configProveedoresAdministrador = {
  location: "ProveedoresAdministrador",
  titulo: "Proveedores",
  campos: camposProveedoresAdministrador,
  clase: "Proveedores",
  nombreFuncion: "Proveedores",
  rol: "ADMINISTRADOR",
  funcionLeer: "listar",
...
const paginaProveedoresAdministrador = new Pagina(configProveedoresAdministrador);

async function getProveedoresAdministrador() {
  await paginaProveedoresAdministrador.get();
}
