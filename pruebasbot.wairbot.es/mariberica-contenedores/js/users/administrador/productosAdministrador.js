...
const camposProductosAdministrador = [
  {
    "tipo": "text",
    "id": "codigo",
    "label": "Código",
...
const configProductosAdministrador = {
  location: "ProductosAdministrador",
  titulo: "Productos",
  campos: camposProductosAdministrador,
  clase: "Productos",
  nombreFuncion: "Productos",
  rol: "ADMINISTRADOR",
  funcionLeer: "listar",
...
const paginaProductosAdministrador = new Pagina(configProductosAdministrador);

async function getProductosAdministrador() {
  await paginaProductosAdministrador.get();
}
