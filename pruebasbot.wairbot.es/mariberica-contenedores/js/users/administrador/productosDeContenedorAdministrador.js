...
const camposProductosDeContenedorAdministrador = [
  {
    "tipo": "dataListApi",
    "id": "id_contenedor",
    "label": "Contenedor",
    "options": "Contenedores::listarIdentificadorContenedorConNavierasMasId"
  },
  {
    "tipo": "dataListApi",
    "id": "id_producto",
    "label": "Producto",
    "options": "Productos::listarDescripcionConCodigoMasId"
  },
  {
    "tipo": "text",
    "id": "divisa",
...
const configProductosDeContenedorAdministrador = {
  location: "ProductosDeContenedorAdministrador",
  titulo: "Productos De Contenedor",
  campos: camposProductosDeContenedorAdministrador,
  clase: "ProductosDeContenedor",
  nombreFuncion: "ProductosDeContenedor",
  rol: "ADMINISTRADOR",
  funcionLeer: "listar",
  funcionModificadoraDeTabla: "",
  camposCard: {
    info1: "PRO_descripcion",
    info2: "PRO_presentacion",
    info3: "PRO_precio",
    info4: "cantidad",
    info5: "divisa",
    id: "id",
...
const paginaProductosDeContenedorAdministrador = new Pagina(configProductosDeContenedorAdministrador);

async function getProductosDeContenedorAdministrador() {
  await paginaProductosDeContenedorAdministrador.get();
}
