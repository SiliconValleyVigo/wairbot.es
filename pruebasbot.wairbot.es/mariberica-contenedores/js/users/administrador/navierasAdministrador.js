...
const camposNavierasAdministrador = [
  {
    "tipo": "text",
    "id": "nombre",
    "label": "Nombre",
...
const configNavierasAdministrador = {
  location: "NavierasAdministrador",
  titulo: "Navieras",
  campos: camposNavierasAdministrador,
  clase: "Navieras",
  nombreFuncion: "Navieras",
  rol: "ADMINISTRADOR",
  funcionLeer: "listar",
...
const paginaNavierasAdministrador = new Pagina(configNavierasAdministrador);

async function getNavierasAdministrador() {
  await paginaNavierasAdministrador.get();
}
