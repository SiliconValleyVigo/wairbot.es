...
function generarMenuData(usuario){
    if(usuario.rol === 'ADMINISTRADOR'){
        ...
        let menuOptions = {
            'Navieras': 'getNavierasAdministrador',
            'Proveedores': 'getProveedoresAdministrador',
            'Productos': 'getProductosAdministrador',
            'Compras': 'getComprasAdministrador',
            'Contenedores': 'getContenedoresAdministrador',
            'Productos de Contenedor': 'getProductosDeContenedorAdministrador',
            'Graficas': 'getGraficasAdministrador',
        };
...
const locationHandlers = {
    'ComprasAdministrador': getComprasAdministrador,
    'ContenedoresAdministrador': getContenedoresAdministrador,
    'GraficasAdministrador': getGraficasAdministrador,
    'NavierasAdministrador': getNavierasAdministrador,
    'ProductosAdministrador': getProductosAdministrador,
    'ProductosDeContenedorAdministrador': getProductosDeContenedorAdministrador,
    'ProveedoresAdministrador': getProveedoresAdministrador,
};
