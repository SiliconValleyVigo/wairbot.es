...
class Compras{
    ...
    public static function listar($request){
        ...
        return [
            'status' => 'success',
            'message' => 'Compras listadas con éxito',
            'data' => [
    ...
    public static function listarNCompraMasId(){
        $conn = $_SESSION['db_connection'];
        $tabla = self::$tabla;

        $sql = "SELECT id, n_compra FROM $tabla";
        $stmt = $conn->prepare($sql);
        $stmt->execute();
        ...
        //poner Compras en formato id => n_compra
        $lista = array_column($lista, 'n_compra', 'id');
