...
class Tools{
    ...
    */
     ...
     *
     * @param string $servidorSMTP Servidor SMTP.
     * @param int $puerto Puerto del servidor SMTP.
     * @param string $usuario Usuario del servidor SMTP.
     * @param string $contrasena Contraseña del servidor SMTP.
     * @param string $de Dirección de correo electrónico del remitente.
     * @param string $para Dirección de correo electrónico del destinatario.
     * @param string $asunto Asunto del correo electrónico.
     * @param string $mensaje Cuerpo del correo electrónico.
     * @param string $urlArchivoAdjunto URL del archivo adjunto (opcional).
     * @return bool Devuelve true si el correo se envió correctamente, de lo contrario false.
     * 
     * Ejemplo de uso:
     * 
