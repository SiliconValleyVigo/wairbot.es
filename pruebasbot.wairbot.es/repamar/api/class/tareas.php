...
class Tareas{
    static public function create($request){
        ...
        if($userRol == 'TECNICO' || $userRol == 'AGENTE'){
            $sql = "SELECT id_tecnico, id_motor FROM partes WHERE id = $id_parte";
    ...
    static public function getByParteId($request){
        ...
        if($result->num_rows > 0){
            ...
            return [
                'status' => 'error',
                'message' => 'Error al obtener las tareas de un parte 1'
            ];
        }
        ...
        if($tareas){
            ...
            return [
                'status' => 'error',
                'message' => 'Error al obtener las tareas de un parte 2'
            ];
        }
